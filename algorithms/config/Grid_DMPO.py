...
def getArgs(radius_p, radius_v, radius_pi, env):
    ...
    alg_args.pretrained_model = 'checkpoints/standard _Grid_Env_MB_DPPOAgent_20103/32957_-383680.2.pt'
...
#############################################################
    ...
    p_args.edge_hidden_size = [4]
    p_args.node_hidden_size = [4]
#############################################################
