# -*- coding: utf-8 -*-
"""
Created on Sun Feb 27 13:47:21 2022
...
# --------------------------------------------------------------------------------------------------------------
            ...
            while not (ep_len == length):
                ...
                for k in range(self.n_agent):
                    ...
                    #v[k].append(s1[k][0]*30)
                    #pos[k].append(s1[k][1]*260)   #for ring

                    v[k].append(s1[k][0]*30)
                    pos[k].append(s1[k][1]*455)   #for eight
...
# test uav : plot_trajectory----------------------------------------------------------------------------------------------------   
            ...
            for j in range(self.n_agent):
                ...
                for r in range(self.test_length):
                    ...
                    temp_pos.append(dp(p_pos[q+r*self.n_agent]))

                v_.append(dp(temp_v))
                pos_.append(dp(temp_pos))
...
# 绘制静态轨迹------------------------------------------------------------------------------------------------------    
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    if j == 3:
                        plt.plot(Step,dp(v_)[j],color='fuchsia',label="vehicle 3")
                    if j == 4:
                        plt.plot(Step,dp(v_)[j],color='purple',label="vehicle 5")
                    if j == 5:
                        plt.plot(Step,dp(v_)[j],color='green',label="vehicle 7")
                ...
                #plt.ylim(0,5)
                plt.grid()  
                plt.savefig('./ring-velocity.png',bbox_inches = 'tight',dpi=1200)
                plt.savefig('./ring-velocity.svg',bbox_inches = 'tight',dpi=1200)
                plt.savefig('./ring-velocity.pdf',bbox_inches = 'tight',dpi=1200)                            
                plt.show()
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    if j == 2:
                        plt.plot(Step,dp(pos_)[j],color='red',label="vehicle 1")
                    if j == 3:
                        plt.plot(Step,dp(pos_)[j],color='fuchsia',label="vehicle 3")
                    if j == 4:
                        plt.plot(Step,dp(pos_)[j],color='purple',label="vehicle 5")
                    if j == 5:
                        plt.plot(Step,dp(pos_)[j],color='green',label="vehicle 7")


                plt.xlabel('Steps',fontsize=15)
                plt.ylabel('Vehicle position(m)',fontsize=15)
                plt.xticks(size = 15)
                plt.yticks(size = 15)
                plt.legend(fontsize=15,loc='upper right')
                plt.grid()
                plt.savefig('./ring-position.png',bbox_inches = 'tight',dpi=1200)
                plt.savefig('./ring-position.svg',bbox_inches = 'tight',dpi=1200)
                plt.savefig('./ring-position.pdf',bbox_inches = 'tight',dpi=1200)                                
                plt.show()
                ...
                for j in range(self.n_agent):  
                    if j in [2,3,4,5]:    
                        ...
                        for i in range(len(Step)):                
                            ws_1.append([Step[i],dp(pos_)[j][i]])   
                            ws_2.append([Step[i],dp(v_)[j][i]])              
                        wb_1.save('./p'+str(j)+'.xlsx') 
                        wb_2.save('./v'+str(j)+'.xlsx') 
            ...
            #             plt.plot(Step,dp(v_)[j],color='red',label="vehicle 1")
            #         if j == 7:
            #             plt.plot(Step,dp(v_)[j],color='fuchsia',label="vehicle 8")
            #         if j == 14:
            #             plt.plot(Step,dp(v_)[j],color='purple',label="vehicle 15")
            #         if j == 21:
            #             plt.plot(Step,dp(v_)[j],color='green',label="vehicle 22")
            #         #if j == 15:
            #             #plt.plot(Step,dp(v_)[j],color='teal',label="vehicle 16")
            #         # if j == 18:
            #         #     plt.plot(Step,dp(v_)[j],color='peru',label="vehicle 19")
            #         # if j == 21:
            #         #     plt.plot(Step,dp(v_)[j],color='royalblue',label='vehicle 22')
            ...
            #             plt.plot(Step,dp(pos_)[j],color='red',label="vehicle 1")
            #         if j == 7:
            #             plt.plot(Step,dp(pos_)[j],color='fuchsia',label="vehicle 8")
            #         if j == 14:
            #             plt.plot(Step,dp(pos_)[j],color='purple',label="vehicle 15")
            #         if j == 21:
            #             plt.plot(Step,dp(pos_)[j],color='green',label="vehicle 22")
            #         #if j == 15:
            #             #plt.plot(Step,dp(pos_)[j],color='teal',label="vehicle 16")
            #         # if j == 18:
            #         #     plt.plot(Step,dp(pos_)[j],color='peru',label="vehicle 19")
            #         # if j == 21:
            #         #     plt.plot(Step,dp(pos_)[j],color='royalblue',label='vehicle 22')
            #     plt.xlabel('Steps',fontsize=15)
            #     plt.ylabel('Vehicle position(m)',fontsize=15)
            #     plt.xticks(size = 15)
            #     plt.yticks(size = 15)
            ...
            #             ws_2['B1'] = 'pos'                            
            #             for i in range(len(Step)):                
            #                 ws_2.append([Step[i],dp(pos_)[j][i]])              
            #             wb_2.save('./p2.xlsx')  
            ...
            #             ws_3['B1'] = 'pos'                            
            #             for i in range(len(Step)):                
            #                 ws_3.append([Step[i],dp(pos_)[j][i]])              
            #             wb_3.save('./p3.xlsx')  
            ...
            #             ws_4['B1'] = 'pos'                            
            #             for i in range(len(Step)):                
            #                 ws_4.append([Step[i],dp(pos_)[j][i]])              
            #             wb_4.save('./p4.xlsx')
