...
from algorithms.mbdppo.MB_DPPO_cacc import OnPolicyRunner
...
def parse_args():
    ...
    parser.add_argument('--env', type=str, required=False, default='slowdown', help="environment(eight/ring/catchup/slowdown/UAV_Nav/Car/UAV_2/UAV_101)")
...
if input_args.algo == 'IA2C':
    from algorithms.mbdppo.MB_DPPO_cacc import IA2C as agent_fn
elif input_args.algo == 'IC3Net':
    from algorithms.mbdppo.MB_DPPO_cacc import IC3Net as agent_fn
elif input_args.algo in ['CPPO', 'DPPO']:
    from algorithms.mbdppo.MB_DPPO_cacc import DPPOAgent as agent_fn
elif input_args.algo in ['DMPO']:
    from algorithms.mbdppo.MB_DPPO_cacc import MB_DPPOAgent as agent_fn
