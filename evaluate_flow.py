# -*- coding: utf-8 -*-
"""
Created on Sun Feb 27 13:45:40 2022
...
from algorithms.mbdppo.MB_DPPO_ring import OnPolicyRunner
...
def parse_args():
    ...
    parser.add_argument('--env', type=str, required=False, default='eight', help="environment(eight/ring/catchup/slowdown/UAV_Nav/Car/UAV_2/UAV_101)")
    parser.add_argument('--algo', type=str, required=False, default='DPPO', help="algorithm(DMPO/IA2C/IC3NET/CPPO/DPPO) ")
...
if input_args.algo == 'IA2C':
    from algorithms.mbdppo.MB_DPPO_ring import IA2C as agent_fn
elif input_args.algo == 'IC3Net':
    from algorithms.mbdppo.MB_DPPO_ring import IC3Net as agent_fn
elif input_args.algo in ['CPPO', 'DPPO']:
    from algorithms.mbdppo.MB_DPPO_ring import DPPOAgent as agent_fn
elif input_args.algo in ['DMPO']:
    from algorithms.mbdppo.MB_DPPO_ring import MB_DPPOAgent as agent_fn
