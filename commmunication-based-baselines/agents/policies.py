...
class FPPolicy(LstmPolicy):
    ...
    def _init_net(self):
        if self.identical:
            ...
            #print("self.n_x =",self.n_x )
            #print("self.n_s=",self.n_s)
            #print("self.n_a=",self.n_a )
            #print("self.n_n=",self.n_n )
        else:
        ...
        n_h = self.n_fc
        if self.n_n:
            #print("self.n_s-self.n_x, self.n_fc=",self.n_s-self.n_x, self.n_fc)
