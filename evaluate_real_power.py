...
from algorithms.algo.main_real_power import OnPolicyRunner
...
def initArgs(run_args, env_train, env_test, input_arg):
    ...
    if input_arg.env in ['eight', 'ring', 'catchup', 'slowdown','Grid','Monaco','PowerGrid', "Real_Power"] or input_arg.algo in ['CPPO', 'DMPO', 'IC3Net', 'IA2C']:
...
def parse_args():
    ...
    parser.add_argument('--env', type=str, required=False, default='Real_Power', help="environment(eight/ring/catchup/slowdown/Grid/Monaco/PowerGrid/Real_Power)")
    parser.add_argument('--algo', type=str, required=False, default='DPPO', help="algorithm(DMPO/IC3Net/CPPO/DPPO/IA2C) ")
    parser.add_argument('--device', type=str, required=False, default='cuda:5', help="device(cpu/cuda:0/cuda:1/...) ")
